package com.ling.msmservice.service.impl;
...
public class MsmServiceImpl implements MsmService {
    ...
    public boolean send(HashMap<String, Object> param, String phone) {
        ...
        DefaultProfile profile = DefaultProfile.getProfile("default", "LTAI5tLkyyNkH92n5kh8GDfp", "HfoGBjoxzy6qIBhqyf3YgL1e3vreZ4");
        ...
        //要求传递的code验证码为json格式，可以使用JSONObject.toJSONString()将map转为json格式
